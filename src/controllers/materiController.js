...
export const updateMateri = async (req, res) => {
  try {
    ...
    // parse is_premium from FormData (string 'true' or 'false')
    const isPremiumProvided = typeof req.body?.is_premium !== "undefined";
    ...
    const isPremiumParam = isPremiumProvided ? is_premium : undefined;
